...
public class Main_correction {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(p.getId()+" , "+p.getMarque()+" , "+p.getReference()+" , "+p.getDateAchat()+" , "+p.getPrice());
        ps.envoie();
        ...
        ps.begin();
        for(Produit produitpascher : ps.getProduitsSup(2100)){
            System.out.println(produitpascher.getId()+" , "+produitpascher.getMarque()+" , "+produitpascher.getReference()+" , "+produitpascher.getDateAchat()+" , "+produitpascher.getPrice());
        }
        ps.envoie();
        ...
        Date date2= new Date("2016/12/30");

        List<Produit> produitsdate = ps.filterByDate(date1,date2);
        for(Produit pr :  produitsdate) {
            System.out.println(pr.getId() + " , " + pr.getMarque() + " , " + pr.getReference() + " , " + pr.getDateAchat() + " , " + pr.getPrice());
        }
