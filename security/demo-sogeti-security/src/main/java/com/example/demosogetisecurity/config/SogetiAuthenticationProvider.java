    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if(customers.size() == 0){
            if(passwordEncoder.matches(password, customers.get(0).getPwd())){
                ...
                throw new BadCredentialsException("ERROR: SogetiAuthProvider.java/invalid password");
            }
        }else{
            throw new BadCredentialsException("ERROR: SogetiAuthProvider.java/No registered user");
        }
    }
